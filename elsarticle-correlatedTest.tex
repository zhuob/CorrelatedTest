...
%\ead{zhuob@oregonstate.edu}

%% or include affiliations in footnotes:
\author[mymainaddress]{Duo Jiang}
%\ead{jiangd@oregonstate.edu}

\author[mymainaddress]{Yanming Di\corref{mycorrespondingauthor}}
\cortext[mycorrespondingauthor]{Corresponding author}
\ead{diy@oregonstate.edu}

\address[mymainaddress]{Department of Statistics, Oregon State University, Corvallis, OR, USA }
%\address[mysecondaryaddress]{Weniger Hall, Room 235, Corvallis, OR, 97331, USA}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=6cm, height= 6cm]{Figures/ct1.eps}
	\includegraphics[width=6cm, height= 6cm]{Figures/ct2.eps}
	\includegraphics[width=6cm, height= 6cm]{Figures/ct3.eps}
	\includegraphics[width=6cm, height= 6cm]{Figures/ct4.eps}
...
\begin{figure}[!th]
	\centering
	\includegraphics[width=3.5cm, height= 4cm]{Figures/case1.eps}
	\includegraphics[width=3.5cm, height= 4cm]{Figures/case2.eps}
	\includegraphics[width=3.5cm, height= 4cm]{Figures/case3.eps}
	\includegraphics[width=3.5cm, height= 4cm]{Figures/case4.eps}
	\includegraphics[width=3.5cm, height= 4cm]{Figures/case5.eps}
	\includegraphics[width=3.5cm, height= 4cm]{Figures/case6.eps}
...
\begin{enumerate}
	...
	i=X, Y$. 
	\begin{equation}\label{eq1}\tag{A.2}
	\begin{aligned}
	...
	\begin{equation}\label{eq2}\tag{A.4}
	\begin{aligned}
...
\begin{align}\label{Stirling1}\tag{B.2}
...
\begin{equation}\label{eq:Bapprox}\tag{B.3}
B \approx  
\begin{cases}
...
\begin{equation}\label{eq:AminusB}\tag{B.4}
A- B \approx  
\begin{cases}
